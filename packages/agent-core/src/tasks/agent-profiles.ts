...
export const AGENT_PROFILES: readonly AgentProfile[] = [
  ...
  },
  {
    ...
    domain: 'reading',
    displayName: '阅读助手',
    description: '阅读和理解长文本、文档',
    icon: '📖',
    systemPrompt:
      'You are a reading agent. Help users understand long documents, extract key ' +
      'information, and provide summaries.',
    model: 'gpt-4o',
    temperature: 0.3,
    maxIterations: 8,
    allowedTools: ['file_read', 'web_fetch', 'grep'],
    blockedTools: ['file_write', 'shell_exec'],
    specializations: ['read', 'summarize', 'understand', 'extract', 'comprehend'],
    outputFormat: 'markdown',
  },
  {
    name: 'assistant',
