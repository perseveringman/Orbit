...
const articlesDef: SqliteTableDef = {
  ...
  columns: [
    ...
    { name: 'media_type', type: 'TEXT', notNull: true, defaultValue: "'web_article'" },
    { name: 'language', type: 'TEXT' },
    { name: 'bundle_path', type: 'TEXT' },
    { name: 'content_file_path', type: 'TEXT' },
    ...
    { name: 'reading_progress', type: 'REAL' },
    { name: 'last_read_position', type: 'TEXT' },
  ...
  indexes: [
    ...
    { name: 'idx_articles_source_endpoint', columns: ['source_endpoint_id'] },
    { name: 'idx_articles_media_type', columns: ['media_type'] },
  ],
};
...
const booksDef: SqliteTableDef = {
  ...
  columns: [
    ...
    { name: 'language', type: 'TEXT' },
    { name: 'format', type: 'TEXT', notNull: true, defaultValue: "'epub'" },
    { name: 'total_chapters', type: 'INTEGER' },
    { name: 'total_pages', type: 'INTEGER' },
    { name: 'bundle_path', type: 'TEXT' },
    { name: 'source_file_path', type: 'TEXT' },
    { name: 'meta_file_path', type: 'TEXT' },
    { name: 'chapters_json_path', type: 'TEXT' },
    { name: 'summary', type: 'TEXT' },
    { name: 'status', type: 'TEXT', notNull: true, defaultValue: "'unread'" },
    { name: 'reading_progress', type: 'REAL' },
    { name: 'last_read_position', type: 'TEXT' },
    { name: 'current_chapter', type: 'INTEGER' },
    { name: 'published_at', type: 'TEXT' },
...
const highlightsDef: SqliteTableDef = {
  ...
  columns: [
    { name: 'id', type: 'TEXT', primaryKey: true },
    { name: 'source_object_type', type: 'TEXT', notNull: true },
    { name: 'source_object_id', type: 'TEXT', notNull: true },
    { name: 'anchor_json', type: 'TEXT', notNull: true },
    { name: 'quote_text', type: 'TEXT', notNull: true },
    { name: 'color', type: 'TEXT' },
    { name: 'note', type: 'TEXT' },
    { name: 'highlight_kind', type: 'TEXT', notNull: true, defaultValue: "'highlight'" },
    { name: 'created_by', type: 'TEXT', notNull: true, defaultValue: "'manual'" },
    { name: 'created_at', type: 'TEXT', notNull: true },
    { name: 'updated_at', type: 'TEXT', notNull: true },
    { name: 'deleted_flg', type: 'INTEGER', notNull: true, defaultValue: '0' },
  ],
  indexes: [
    { name: 'idx_highlights_source', columns: ['source_object_type', 'source_object_id'] },
    { name: 'idx_highlights_kind', columns: ['highlight_kind'] },
  ],
};
...
const notesDef: SqliteTableDef = {
  ...
  columns: [
    ...
    { name: 'body', type: 'TEXT' },
    { name: 'kind', type: 'TEXT', notNull: true, defaultValue: "'fleeting'" },
    { name: 'maturity', type: 'TEXT', notNull: true, defaultValue: "'inbox'" },
    { name: 'origin', type: 'TEXT', notNull: true, defaultValue: "'manual'" },
    { name: 'source_object_type', type: 'TEXT' },
    { name: 'source_object_id', type: 'TEXT' },
  ...
  indexes: [
    { name: 'idx_notes_kind', columns: ['kind'] },
    { name: 'idx_notes_maturity', columns: ['maturity'] },
  ],
};
...
const sourceEndpointsDef: SqliteTableDef = {
  ...
  columns: [
    ...
    { name: 'fetch_interval_minutes', type: 'INTEGER', defaultValue: '60' },
...
const derivativeAssetsDef: SqliteTableDef = {
  name: 'derivative_assets',
  columns: [
    { name: 'id', type: 'TEXT', primaryKey: true },
    { name: 'source_object_id', type: 'TEXT', notNull: true },
    { name: 'asset_type', type: 'TEXT', notNull: true },
    { name: 'target_locale', type: 'TEXT' },
    { name: 'provider', type: 'TEXT' },
    { name: 'generation_config_json', type: 'TEXT' },
    { name: 'content_json', type: 'TEXT' },
    { name: 'file_path', type: 'TEXT' },
    { name: 'status', type: 'TEXT', notNull: true, defaultValue: "'pending'" },
    { name: 'progress', type: 'REAL', notNull: true, defaultValue: '0' },
  ...
  indexes: [
    { name: 'idx_derivatives_source', columns: ['source_object_id', 'asset_type'] },
    { name: 'idx_derivatives_status', columns: ['status'] },
  ],
};
